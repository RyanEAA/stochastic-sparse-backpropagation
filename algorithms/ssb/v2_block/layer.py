...
from algorithms.ssb.v2.function import SparseLinearFunctionV2


class BlockSparseLinearV2(nn.Module):
    """V2 SSB with contiguous block-correlated backward sparsity.

    This is the block-structured counterpart of V2: forward remains dense and
    active block gradients are inverse-probability scaled by ``1 / keep_ratio``.
    """
